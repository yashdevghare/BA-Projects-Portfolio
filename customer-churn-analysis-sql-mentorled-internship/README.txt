# Customer Churn Analysis – Digital Banking Domain
...
## 🧰 Tools & Technologies
- **SQL** – For all data querying, filtering, and analysis  
- **MS Excel** – For additional segmentation and summarization  
- **Data Analysis Techniques** – Univariate, Bivariate, Segmentation Analysis  
- **Business Analytics Frameworks** – Data-driven decision-making

---

## 📄 Files in Repository
- `Bank_Churn_Dataset.csv` – Original dataset
- `Complete_Code_Customer_Churn_Analysis.sql` – Full SQL code for analysis
- `insights_and_recommendations_report.pdf` – Detailed findings & strategies
- `review_report_of_selected_metrics.pdf` – Metric-wise churn review

---

## 🏆 Outcome
The analysis provided **clear churn driver identification** and **actionable retention strategies**.  
If implemented, the recommendations can **reduce churn by an estimated 10–15%**, leading to increased revenue and stronger customer loyalty.
